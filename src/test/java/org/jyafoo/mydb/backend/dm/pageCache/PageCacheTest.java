...
public class PageCacheTest {
    ...
    public void testPageCache() throws Exception {
        PageCache pc = PageCache.create("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_simple_test0", PageCache.PAGE_SIZE * 50);
        for(int i = 0 ; i < 100; i ++) {
        ...
        pc = PageCache.open("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_simple_test0", PageCache.PAGE_SIZE * 50);
        for(int i = 1; i <= 100; i ++) {
        ...
        assert new File("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_simple_test0.db").delete();
    }
    ...
    public void testPageCacheMultiSimple() throws Exception {
        pc1 = PageCache.create("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_simple_test1", PageCache.PAGE_SIZE * 50);
        ...
        cdl1.await();
        pc1.close();
        assert new File("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_simple_test1.db").delete();
    }
    ...
    public void testPageCacheMulti() throws InterruptedException {
        pc2 = PageCache.create("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_multi_test", PageCache.PAGE_SIZE * 10);
        ...
        cdl2.await();
        pc2.close();
        assert new File("C:\\Users\\JIA\\Desktop\\HLJU_CSTI\\25020-数据库科系统概论\\25022-实验代码\\20225958 李嘉富\\实验三四\\MYDB\\src\\main\\resources\\db\\pcacher_multi_test.db").delete();
    }
